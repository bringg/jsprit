...
public class GreedyInsertionByAverageTest {
    ...
    public void shipment1ShouldBeAddedFirst() {
        ...
        GreedyInsertionByAverage greedyInsertion = new GreedyInsertionByAverage(calculator, vrp, fleetManager);
        Collection<VehicleRoute> routes = new ArrayList<VehicleRoute>();

        CkeckJobSequence position = new CkeckJobSequence(2, s2);
        greedyInsertion.addListener(position);
        greedyInsertion.insertJobs(routes, vrp.getJobs().values());
